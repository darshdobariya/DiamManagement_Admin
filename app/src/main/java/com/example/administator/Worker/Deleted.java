...
public class Deleted extends Fragment {

    RecyclerView recyclerView;
    DeletedAdapter user_listAdaptor;
    List<User> user_list;
    ...
    public void onViewCreated(@NonNull @org.jetbrains.annotations.NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById( R.id.rcDelete );
        ...
        myRef = database.getReference( "Maruti Daim" ).child( "User" ).child( "Delete" );
        getdata();
    }
    ...
    public void getdata() {
        ...
        user_listAdaptor = new DeletedAdapter( getActivity(), user_list );
        recyclerView.setAdapter( user_listAdaptor );
    }

    public class DeletedAdapter extends RecyclerView.Adapter<ViewHolder> {
        Context context;
        List<User> user_list;

        public DeletedAdapter(Context context, List<User> user_list) {
